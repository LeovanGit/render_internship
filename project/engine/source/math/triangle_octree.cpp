...
//     box = initialBox = { mesh.box.min - eps, mesh.box.max + eps };
...
//     if (!ray.intersect(box_t, m_box, true))
//         return false;
...
//     for (int i = 0; i < 8; ++i)
//     {
//         if ((*children)[i].box.contains(ray.pos))
//         {
//             box_intersections[i].index = i;
//             box_intersections[i].t = 0.f;
//         }
//         else
//         {
//             float box_t = nearest.t;
//             if (ray.intersect(box_t, (*m_children)[i].m_box, true))
//             {
//                 box_intersections[i].index = i;
